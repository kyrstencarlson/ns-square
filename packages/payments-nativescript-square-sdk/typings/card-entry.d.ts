...
declare module sqip {
	export class CardNonceBackgroundHandler {
		...
		public constructor(implementation: {
			handleEnteredCardInBackground(param0: sqip.CardDetails): sqip.CardEntryActivityCommand;
		});
		public constructor();
...
declare module sqip {
	export class KotlinExtensions {
		...
		public static handleActivityResult($i$f$handleActivityResult: sqip.CardEntry, $this$handleActivityResult: globalAndroid.content.Intent, data: any<any,any>): void;
		public static enqueue($i$f$enqueue: sqip.Call, $this$enqueue: any): void;
		public static setCardNonceBackgroundHandler($i$f$setCardNonceBackgroundHandler: sqip.CardEntry, $this$setCardNonceBackgroundHandler: any<any,any>): void;
	}
}
