...
declare class PKPaymentRequest extends NSObject {
	...
	static squarePaymentRequestWithMerchantIdentifierCountryCodeCurrencyCode(merchantIdentifier: string, countryCode: string, currencyCode: string): PKPaymentRequest;
