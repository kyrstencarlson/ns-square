...
declare module sqip {
	export module internal {
		export class FakeMode {
			...
			public sendResult(callback: any<any,any>): void;
			public setResultsProvider(callback: any<sqip.internal.Result<sqip.internal.CardEntryResult.CardAndNonceResult,string>>): void;
		}
	}
}
...
declare module sqip {
	export module internal {
		export class Parceler<T>  extends java.lang.Object {
			 ...
			 */
			public constructor(implementation: {
				write(param0: T, param1: globalAndroid.os.Parcel, param2: number): void;
				create(param0: globalAndroid.os.Parcel): T;
	...
	export module internal {
		...
		export module SqipActivityDebouncer {
			export class Companion {
				...
				public reset(): void;
				public install($i$a$-synchronized-SqipActivityDebouncer$Companion$install$1: globalAndroid.content.Context, childEntries: string): boolean;
	...
	export module internal {
		export module event {
			export class EventLogger {
				 ...
				 */
				public constructor(implementation: {
					updateCustomThemeAttributes(param0: string): void;
					log(param0: sqip.internal.event.IapEvent): void;
					uploadLogs(): void;
	...
	export module internal {
		export module event {
			export class EventLogger_Real_Factory extends dagger.internal.Factory<sqip.internal.event.EventLogger.Real> {
				...
				public static create(eventStreamServiceProvider: javax.inject.Provider<sqip.internal.event.EventStreamService>, eventsUploadExecutorProvider: javax.inject.Provider<java.util.concurrent.ExecutorService>, eventJsonAdapterProvider: javax.inject.Provider<com.squareup.moshi.JsonAdapter<sqip.internal.event.IapEventJsonData>>, resourcesProvider: javax.inject.Provider<globalAndroid.content.res.Resources>, apkInfoProvider: javax.inject.Provider<sqip.internal.ApkInfo>, localeProvider: javax.inject.Provider<java.util.Locale>, squareDeviceIdProvider: javax.inject.Provider<string>): sqip.internal.event.EventLogger_Real_Factory;
		...
		export module event {
			...
			export module EventModule {
				export class BindsModule {
					 ...
					 */
					public constructor(implementation: {
						eventLogger(param0: sqip.internal.event.EventLogger.Real): sqip.internal.event.EventLogger;
					});
					public constructor();
	...
	export module internal {
		export module event {
			export class EventStreamService {
				 ...
				 */
				public constructor(implementation: {
					logEvents(param0: sqip.internal.event.LogEventsRequest): retrofit2.Call<sqip.internal.event.LogEventsResponse>;
				});
				public constructor();
	...
	export module internal {
		export module event {
			export class IapEventJsonData {
				...
				public constructor(recordedAtMs: number, sqip_base_square_application_id: string, sqip_base_device_locale_country_code: string, sqip_base_device_language: string, sqip_base_square_device_id: string, sqip_base_has_flutter_plugin: boolean, sqip_base_has_flutter: boolean, sqip_base_has_react_native: boolean, sqip_base_has_react_native_plugin: boolean, sqip_base_orientation: string, sqip_base_screen_width_pixels: number, sqip_base_screen_height_pixels: number, sqip_base_time_zone: string, sqip_base_is_app_debug_build: boolean, sqip_base_is_sdk_debug_build: boolean, sqip_android_base_app_package_name: string, sqip_android_base_app_version_name: string, sqip_android_base_app_version_code: number, sqip_android_base_target_api_version: number, sqip_android_base_min_api_version: number, sqip_android_base_screen_density_dpi: number, sqip_android_base_device_year_class: number, sqip_android_base_apk_byte_size: number, sqip_android_base_uses_androidx: boolean, sqip_android_base_process_uuid: string, sqip_card_entry_base_name: string, sqip_card_entry_base_session_uuid: string, sqip_card_entry_base_session_order: number, sqip_card_entry_base_theme: string, sqip_card_entry_base_validation_error_field: string, sqip_card_entry_base_nonce_error_code: string, sqip_card_entry_base_app_error_message: string, sqip_card_entry_base_flow_type: string, sqip_card_entry_base_amount: number, sqip_card_entry_base_buyer_action: string, sqip_card_entry_base_contact_empty_fields: string, sqip_card_entry_base_currency: string, sqip_card_entry_base_location_id: string, sqip_card_entry_base_challenges_completed_count: number, sqip_card_entry_base_challenges_total_count: number, sqip_card_entry_base_error_code: string, sqip_card_entry_base_error_description: string, sqip_card_entry_base_has_challenged_user: boolean, sqip_card_entry_base_verification_duration_in_milliseconds: number, sqip_card_entry_base_three_ds_trans_status: string, sqip_card_entry_base_challenge_type: string, sqip_card_entry_base_verification_token: string, sqip_card_entry_base_three_ds_server_trans_id: string, sqip_card_entry_base_three_ds_warning_severity: string, sqip_card_entry_base_three_ds_warning_code: string, sqip_card_entry_base_three_ds_warning_description: string, sqip_base_device_model: string, sqip_android_base_device_sdk_int: number, sqip_android_base_device_manufacturer: string, sqip_android_base_device_brand: string, u_library_name: string, u_library_version: string);
				...
				public copy(recordedAtMs: number, sqip_base_square_application_id: string, sqip_base_device_locale_country_code: string, sqip_base_device_language: string, sqip_base_square_device_id: string, sqip_base_has_flutter_plugin: boolean, sqip_base_has_flutter: boolean, sqip_base_has_react_native: boolean, sqip_base_has_react_native_plugin: boolean, sqip_base_orientation: string, sqip_base_screen_width_pixels: number, sqip_base_screen_height_pixels: number, sqip_base_time_zone: string, sqip_base_is_app_debug_build: boolean, sqip_base_is_sdk_debug_build: boolean, sqip_android_base_app_package_name: string, sqip_android_base_app_version_name: string, sqip_android_base_app_version_code: number, sqip_android_base_target_api_version: number, sqip_android_base_min_api_version: number, sqip_android_base_screen_density_dpi: number, sqip_android_base_device_year_class: number, sqip_android_base_apk_byte_size: number, sqip_android_base_uses_androidx: boolean, sqip_android_base_process_uuid: string, sqip_card_entry_base_name: string, sqip_card_entry_base_session_uuid: string, sqip_card_entry_base_session_order: number, sqip_card_entry_base_theme: string, sqip_card_entry_base_validation_error_field: string, sqip_card_entry_base_nonce_error_code: string, sqip_card_entry_base_app_error_message: string, sqip_card_entry_base_flow_type: string, sqip_card_entry_base_amount: number, sqip_card_entry_base_buyer_action: string, sqip_card_entry_base_contact_empty_fields: string, sqip_card_entry_base_currency: string, sqip_card_entry_base_location_id: string, sqip_card_entry_base_challenges_completed_count: number, sqip_card_entry_base_challenges_total_count: number, sqip_card_entry_base_error_code: string, sqip_card_entry_base_error_description: string, sqip_card_entry_base_has_challenged_user: boolean, sqip_card_entry_base_verification_duration_in_milliseconds: number, sqip_card_entry_base_three_ds_trans_status: string, sqip_card_entry_base_challenge_type: string, sqip_card_entry_base_verification_token: string, sqip_card_entry_base_three_ds_server_trans_id: string, sqip_card_entry_base_three_ds_warning_severity: string, sqip_card_entry_base_three_ds_warning_code: string, sqip_card_entry_base_three_ds_warning_description: string, sqip_base_device_model: string, sqip_android_base_device_sdk_int: number, sqip_android_base_device_manufacturer: string, sqip_android_base_device_brand: string, u_library_name: string, u_library_version: string): sqip.internal.event.IapEventJsonData;
